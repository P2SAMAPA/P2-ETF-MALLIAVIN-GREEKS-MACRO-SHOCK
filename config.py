...
OUTPUT_REPO = "P2SAMAPA/p2-etf-malliavin-greeks-macro-shock-results"
...
HORIZON = 21                 # forward horizon (days)
PERTURBATION = 0.01          # relative shock size (1% change in macro)
TOP_N = 3
